...
const currentClients = clients.slice(startIndex, endIndex);
  ...
  useEffect(() => {
    axios
      .get("/clients") // appel à /api/clients (grâce à baseURL)
      .then((res) => {
        const formatted = res.data.data.map((client) => ({
          id: client.id,
        ...
        setClients(formatted);     // on initialise la liste affichée
        setLoading(false);
      })
      .catch((err) => {
...
useEffect(() => {
  ...
  <AlertDialogContent>
    ...
    <AlertDialogFooter>
      ...
      <AlertDialogAction onClick={handleSubmit} >Enregistrer</AlertDialogAction>
    </AlertDialogFooter>
  </AlertDialogContent>
</AlertDialog>
